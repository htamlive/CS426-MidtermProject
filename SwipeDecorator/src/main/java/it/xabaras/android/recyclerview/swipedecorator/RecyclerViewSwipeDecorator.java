...
public class RecyclerViewSwipeDecorator {
    ...
    private SwipeRecyclerViewContract swipeRecyclerViewContract;
            ...
            if ( dX > 0 ) {
                ...
                if ( swipeRightBackgroundColor != 0 ) {
                    if ( mSwipeRightCornerRadius != 0 ) {
                        ...
                        if(swipeRecyclerViewContract.enableAdjacentCornerRadii()) {
                            background.setCornerRadii(new float[]{mSwipeLeftCornerRadius, mSwipeLeftCornerRadius, mSwipeLeftCornerRadius, mSwipeLeftCornerRadius, mSwipeLeftCornerRadius, mSwipeLeftCornerRadius, mSwipeLeftCornerRadius, mSwipeLeftCornerRadius});
                        } else {
                ...
                if ( swipeRightActionIconId != 0 && dX > iconHorizontalMargin ) {
                    // context get rotate drawable
                    Drawable tmp_icon = ContextCompat.getDrawable(recyclerView.getContext(), swipeRightActionIconId);
                    if ( tmp_icon != null ) {
                        RotateDrawable icon = new RotateDrawable();
                        icon.setDrawable(tmp_icon);
                        icon = swipeRecyclerViewContract.iconTransformOnSwipeRight(icon,dX);
                ...
                if ( swipeLeftActionIconId != 0 && dX < - iconHorizontalMargin ) {
                    ...
                    if ( tmp_icon != null ) {
                        RotateDrawable icon = new RotateDrawable();
                        icon.setDrawable(tmp_icon);
                        icon = swipeRecyclerViewContract.iconTransformOnSwipeLeft(icon,dX);
                        iconSize = icon.getIntrinsicHeight();
                        int halfIcon = iconSize / 2;
                        int top = viewHolder.itemView.getTop() + ((viewHolder.itemView.getBottom() - viewHolder.itemView.getTop()) / 2 - halfIcon);
    ...
    public void setSwipeRecyclerViewContract(SwipeRecyclerViewContract swipeRecyclerViewContract) {
        this.swipeRecyclerViewContract = swipeRecyclerViewContract;
    }
    ...
    public static class Builder {
        ...
        public Builder setSwipeRecyclerViewContract(SwipeRecyclerViewContract swipeRecyclerViewContract) {
            mDecorator.setSwipeRecyclerViewContract(swipeRecyclerViewContract);
            return this;
        }
